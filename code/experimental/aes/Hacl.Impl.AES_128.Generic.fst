...
unfold type keyr (m:m_spec) = lbuffer (stelem m) (9ul *. klen m)
unfold type keyex (m:m_spec) = lbuffer (stelem m) (15ul *. klen m) // Saving space for AES-256
